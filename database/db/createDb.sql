...
CREATE TABLE ImageAlbum (
  ...
  aid INTEGER REFERENCES Album(aid) ON DELETE CASCADE,
...
CREATE TABLE Thread (
  ...
  event INTEGER REFERENCES Event(eid) ON DELETE CASCADE,
...
CREATE TABLE Comment (
  ...
  thread INTEGER REFERENCES Thread(tid) ON DELETE CASCADE,
